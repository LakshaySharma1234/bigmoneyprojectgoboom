      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">CaterStaff</span>
          </div>
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Create Account</h2>
          <p className="text-gray-600">Join our catering community today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              ...
              <span className="text-xs text-gray-500 mt-1">Looking for work</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-gray-500 mt-1">Hiring staff</span>
            </button>
          </div>
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full py-6 text-base font-medium border-gray-300 hover:bg-gray-50"
            >
